...
pander(MCResult.getData(data1), caption = "Uploaded data. X = Reference method Y = Test method")
}
```
...
method.bootstrap.ci = input$metbootci,
mref.name = input$var1, mtest.name = input$var2)
pander(getCoefficients(data1), caption = "Estimates for slope and intercept.")
}
```
